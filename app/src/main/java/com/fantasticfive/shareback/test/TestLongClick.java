package com.fantasticfive.shareback.test;
...
public class TestLongClick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_long_click);
        ...
        mAdapter = new CustomAdapter(this,R.layout.test_custom_layout, list);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(TestLongClick.this, string, Toast.LENGTH_SHORT).show();
