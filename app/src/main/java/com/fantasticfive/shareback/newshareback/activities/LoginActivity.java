...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            Boolean result = null;
            try {
                Socket skt = new Socket(Constants.IP_FILE_SERVER, Constants.PORT_LOGIN);

                JSONObject main = new JSONObject();
                main.put(Constants.JSON_USERNAME, mEmail);
                main.put(Constants.JSON_PASSWORD, mPassword);

                send(skt, main.toString());

                String response = receive(skt);
                if(response != null) {
        ...
        protected void send(Socket skt, String msg){
            try {
                //Sending Request
        ...
        protected String receive(Socket skt){
            try {
                //Reading Response
