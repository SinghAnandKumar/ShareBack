...
package com.fantasticfive.shareback.newshareback.activities.nsd;
    ...
    public void initializeDiscoveryListener() {
        mDiscoveryListener = new NsdManager.DiscoveryListener() {
            ...
            public void onDiscoveryStarted(String regType) {
                ...
                Toast.makeText(mContext, "Looking for Services...", Toast.LENGTH_SHORT).show();
            }
    ...
    public void initializeRegistrationListener() {
        mRegistrationListener = new NsdManager.RegistrationListener() {
            ...
            public void onServiceRegistered(NsdServiceInfo NsdServiceInfo) {
                ...
                Toast.makeText(mContext, "Service Registerd with name: "+mServiceName, Toast.LENGTH_SHORT).show();
